...
export default function LeftSection() {
    ...
    return (
        <section className="bg-white rounded-[20px] h-[616px] w-1/3 flex flex-col items-center gap-3 pb-7">
            {/* Photo Profile */}
            ...
            <div className='bg-[#F2F5F9] rounded-[20px] w-[350px] h-[350px] flex flex-col items-center justify-center border-collapse'>
                ...
                <div className='flex flex-row border-b  p-5 items-center gap-3 w-[300px]'>
                    ...
                    <div className='flex flex-col'>
                        ...
                        <span>mfaishal.works@gmail.com</span>
                    </div>
                </div>
                ...
                <button className="flex flex-row w-auto mt-4 px-5 bg-gradient-to-r from-orange-400 to-red-500 text-white py-2 rounded-full items-center justify-center gap-2">
